...
const findOne = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.status(404).send({ message: `Grades id: ${id} não encontrado!` });
    } else {
      res.send(data);
    }
...
const update = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res
        .status(404)
        .send({ message: `Grades id: ${id} não encontrado para update!` });
    } else {
...
const remove = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res
        .status(404)
        .send({ message: `Grades id: ${id} não encontrado para delete!` });
    } else {
...
const removeAll = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res
        .status(404)
        .send({ message: `Grades não encontrados para exclusão total!` });
    } else {
      res.send({
